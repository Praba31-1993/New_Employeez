            ...
            <div className='row w-100'>
                ...
                <div className='col-sm-6 align-items-center  d-flex' >
                    <div className='logincard ps-md-5 ms-md-5'>
                        ...
                        <h4 className='heading d-flex align-items-center pt-4'>Welcome to EmployEZ1! <Image src={handwave} className="ms-2" alt={""} /> </h4>
                        <p className="shade para pt-1">Please sign-in to your account and start the adventure </p>
                        <div className="form_filed">
                            <input className="ps-3 py-2 mt-2" type="text" placeholder="User ID" />
                            <input className="ps-3 py-2 mt-3" type="text" placeholder="Password" />
                            <div className="row pt-2">
                                <div className="col-6">
                                    <p className="shade mb-0 para ">
                                        <Checkbox checked={checked} onChange={handleChange} inputProps={{ 'aria-label': 'controlled' }} /> Remember me
                                    </p>
                                </div>
                            ...
                            <div className="mutlicolourbtn mt-2 py-1 text-center" onClick={handleClick}>Login</div>
                        </div>
                        <p></p>
                    </div>
                </div>
