                        ...
                        <div className="col-lg-4 col-xxl-3 borderright" >
                            <div className="row">
                                <div className="col-lg-12 col-sm-6">
                                    ...
                                    <div className="d-flex pt-2 align-items-center" style={{ cursor: "pointer" }} onClick={handlePopupClick}
                                    ><div className="round mr-2" style={{ backgroundColor: "#14E002" }}></div><p className="para mb-0 unselectcolor">Total regular (Billable) hrs: 05</p></div>
                                    <div className="d-flex pt-2 align-items-center"><div className="round mr-2" ></div><p className="para mb-0 unselectcolor">Total hrs (Summary view): 05</p></div>
                                </div>
                                <div className="col-lg-12 col-sm-6">
                                    {/* timesheet approver */}
