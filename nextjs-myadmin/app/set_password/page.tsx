            ...
            <div className='row w-100'>
                ...
                <div className='col-sm-6 align-items-center  d-flex' >
                    <div className='logincard ps-md-5 ms-md-5'>
                        ...
                        <h4 className='heading d-flex align-items-center pt-4'>Setup password </h4>
                        ...
                        <div className="form_filed">
                            ...
                            <input className="ps-3 py-2 mt-3" type="text" placeholder="Conform password" />
                            <div className="mutlicolourbtn mt-2 py-1 text-center">Reset password</div>
                        </div>
